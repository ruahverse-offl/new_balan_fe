...
// Order status uses real backend APIs
...
/**
 * Prescription uploads are not accepted via the app; direct users to WhatsApp/phone.
 */
export const uploadPrescription = async () => {
    return {
        ...
        message:
            `📋 **Prescription**\n\n` +
            `We don’t accept prescription uploads in the chat. Please **WhatsApp or call** us with a clear photo or PDF of your prescription:\n\n` +
            `📞 ${SHOP_INFO.phone}\n` +
    ...
    switch (intent) {
        ...
        case 'prescription':
            return {
                ...
                message:
                    `📋 **Prescription**\n\n` +
                    `Please **WhatsApp or call** us with a clear photo or PDF of your prescription. Our team will help you place the order.\n\n` +
                    `📞 **Call/WhatsApp**: ${SHOP_INFO.phone}\n` +
                    `⏰ **Order Timings**: ${SHOP_INFO.orderTimings}\n\n` +
