                ...
                return (
                    <div className="section-content animate-fade">
                        <div className="welcome-banner">
                            <h1>Welcome back, {user?.name || user?.full_name || user?.email || 'User'}! 👋</h1>
                        ...
                        <div className="header-actions">
                            ...
                            <div className="user-profile" onClick={() => setActiveTab('profile')}>
                                <div className="user-info">
                                    <span className="user-name">{user?.name || user?.full_name || user?.email || 'User'}</span>
                                    <span className="user-role">{(user?.role || 'Member').charAt(0).toUpperCase() + (user?.role || 'Member').slice(1).toLowerCase()}</span>
                                </div>
