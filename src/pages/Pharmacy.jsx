...
import { ShoppingCart, Search, Filter, AlertCircle, ShoppingBag, Trash2, Plus, Minus, X, Clock, Check, ChevronDown, Loader2, Package, Eye } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const [medicinesResponse, therapeuticCategoriesResponse, settings] = await Promise.all([
                                        ...
                                        {brandSelectorProduct?.id === prod.id && (
                                            <div className="brand-selector" ref={brandSelectorRef}>
                                                ...
                                                <div className="brand-selector-list">
                                                    {(brandsMap[prod.id] || []).filter(isBrandPurchasable).map(brand => (
                                                        <button
                                                            key={brand.id}
