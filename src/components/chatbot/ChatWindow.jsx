...
import { X, Send, Upload, ShoppingCart, MapPin, ArrowRight } from 'lucide-react';
import { processMessage, uploadPrescription, getOrderStatus } from '../../services/chatbotApi';
...
const ChatWindow = ({ isOpen, onClose }) => {
    ...
    const renderMessageContent = (content) => {
        switch (content.type) {
            ...
            case 'prescription':
                return (
                    <div className="message-prescription">
                        <div className="message-text">
                            {content.message.split('\n').map((line, i) => (
                                <p key={i}>{line}</p>
                            ))}
